...
- bc747ff: List the server in the official MCP Registry. Adds the `mcpName` marker the registry
...
- 85657dc: Redesigned the connect page, which is the only thing a remote user sees before handing
...
- 748952c: Fixed a bug in `log-body-measurement` that permanently destroyed thigh measurements.
