...
- Never edit `CHANGELOG.md` by hand; it is generated by `yarn version` from changesets.
...
- `CHANGELOG.md` and the version bump are produced by `yarn version`; `yarn release`
  publishes. Do not bump versions by hand.
